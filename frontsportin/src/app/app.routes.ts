...
const protectedRoutes: Routes = [
  ...
  {
    path: 'temporada/club/:id_club',
    component: TemporadaAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  { path: 'temporada/view/:id', component: TemporadaAdminViewPage, data: { allowClubAdmin: true } },
  {
    ...
    component: TemporadaAdminDeletePage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'articulo/tipoarticulo/:id_tipoarticulo',
    component: ArticuloAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'articulo/:tipoarticulo',
    component: ArticuloAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  { path: 'articulo/view/:id', component: ArticuloAdminViewPage, data: { allowClubAdmin: true } },
  {
    path: 'articulo/delete/:id',
    component: ArticuloAdminDeletePage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'categoria/temporada/:id_temporada',
    component: CategoriaAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'partido/teamadmin',
    component: PartidoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'partido/liga/:id_liga',
    component: PartidoAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'factura/usuario/:id_usuario',
    component: FacturaAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'compra/articulo/:id_articulo',
    component: CompraAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'compra/factura/:id_factura',
    component: CompraAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'tipoarticulo/club/:id_club',
    component: TipoarticuloAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'tipoarticulo/view/:id',
    component: TipoarticuloAdminViewPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'tipoarticulo/edit/:id',
    component: TipoarticuloAdminEditPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'jugador/usuario/:id_usuario',
    component: JugadorAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'jugador/equipo/:id_equipo',
    component: JugadorAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'tipoarticulo/delete/:id',
    component: TipoarticuloAdminDeletePage,
    data: { allowClubAdmin: true },
  },
  { path: 'noticia', component: NoticiaAdminPlistPage, pathMatch: 'full' },
  {
    path: 'noticia/teamadmin',
    component: NoticiaPlistTeamadminPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'noticia/club/:id_club',
    component: NoticiaAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'cuota/equipo/:id_equipo',
    component: CuotaAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'equipo/categoria/:id_categoria',
    component: EquipoAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'comentario/usuario/:id_usuario',
    component: ComentarioAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'comentario/noticia/:id_noticia',
    component: ComentarioAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'comentario/view/:id',
    component: ComentarioAdminViewPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'pago/jugador/:id_jugador',
    component: PagoAdminPlistPage,
    data: { allowClubAdmin: true },
  },
...

  {
    ...
    component: CategoriaAdminDeletePage,
    data: { allowClubAdmin: true },
  },
  { path: 'puntuacion', component: PuntuacionAdminPlistPage, data: { allowClubAdmin: true } },
  {
    path: 'puntuacion/noticia/:id_noticia',
    component: PuntuacionAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'puntuacion/usuario/:id_usuario',
    component: PuntuacionAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  { path: 'puntuacion/new', component: PuntuacionAdminNewPage },
  {
    path: 'puntuacion/view/:id',
    component: PuntuacionAdminViewPage,
    data: { allowClubAdmin: true },
  },
  ...
  {
    path: 'comentarioart/articulo/:id_articulo',
    component: ComentarioartAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'comentarioart/usuario/:id_usuario',
    component: ComentarioartAdminPlistPage,
    data: { allowClubAdmin: true },
  },
  {
    path: 'comentarioart/view/:id',
    component: ComentarioartAdminViewPage,
    data: { allowClubAdmin: true },
  },
...
export const routes: Routes = [
  ...
  {
    path: 'usuario/teamadmin',
    component: UsuarioTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'usuario/teamadmin/club/:id_club',
    component: UsuarioTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  ...
  { path: 'equipo/teamadmin', component: EquipoTeamadminPlistPage, canActivate: [ClubAdminGuard] },
  {
    path: 'equipo/teamadmin/categoria/:id_categoria',
    component: EquipoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'equipo/teamadmin/usuario/:id_usuario',
    component: EquipoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  { path: 'liga/teamadmin', component: LigaTeamadminPlistPage, canActivate: [ClubAdminGuard] },
  {
    path: 'liga/teamadmin/equipo/:id_equipo',
    component: LigaTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'partido/teamadmin',
  ...
  {
    path: 'partido/teamadmin/liga/:id_liga',
    component: PartidoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'jugador/teamadmin',
    component: JugadorTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'jugador/teamadmin/equipo/:id_equipo',
    component: JugadorTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'jugador/teamadmin/usuario/:id_usuario',
    component: JugadorTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  { path: 'cuota/teamadmin', component: CuotaTeamadminPlistPage, canActivate: [ClubAdminGuard] },
  {
    path: 'cuota/teamadmin/equipo/:id_equipo',
    component: CuotaTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  ...
  {
    path: 'pago/teamadmin/jugador/:id_jugador',
    component: PagoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
  ...
  {
    path: 'noticia/teamadmin/club/:id_club',
    component: NoticiaPlistTeamadminPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'articulo/teamadmin',
    component: ArticuloTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'articulo/teamadmin/tipoarticulo/:id_tipoarticulo',
    component: ArticuloTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'factura/teamadmin',
    component: FacturaTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'factura/teamadmin/usuario/:id_usuario',
    component: FacturaTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'puntuacion/teamadmin',
    component: PuntuacionTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'puntuacion/teamadmin/usuario/:id_usuario',
    component: PuntuacionTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'puntuacion/teamadmin/noticia/:id_noticia',
    component: PuntuacionTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  { path: 'compra/teamadmin', component: CompraTeamadminPlistPage, canActivate: [ClubAdminGuard] },
  {
    path: 'compra/teamadmin/articulo/:id_articulo',
    component: CompraTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'compra/teamadmin/factura/:id_factura',
    component: CompraTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'carrito/teamadmin',
    component: CarritoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'carrito/teamadmin/articulo/:id_articulo',
    component: CarritoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'carrito/teamadmin/usuario/:id_usuario',
    component: CarritoTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentario/teamadmin',
    component: ComentarioTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentario/teamadmin/noticia/:id_noticia',
    component: ComentarioTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentario/teamadmin/usuario/:id_usuario',
    component: ComentarioTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'tipoarticulo/teamadmin',
    component: TipoarticuloTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'tipoarticulo/teamadmin/club/:id_club',
    component: TipoarticuloTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  ...
  {
    path: 'equipo/teamadmin/view/:id',
    component: EquipoTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'equipo/teamadmin/new',
    component: EquipoTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'equipo/teamadmin/edit/:id',
    component: EquipoTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'equipo/teamadmin/delete/:id',
    component: EquipoTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'liga/teamadmin/view/:id',
    component: LigaTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  { path: 'liga/teamadmin/new', component: LigaTeamadminNewPage, canActivate: [ClubAdminGuard] },
  {
    path: 'liga/teamadmin/edit/:id',
    component: LigaTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'liga/teamadmin/delete/:id',
    component: LigaTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'partido/teamadmin/view/:id',
    component: PartidoTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'partido/teamadmin/new',
    component: PartidoTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'partido/teamadmin/edit/:id',
    component: PartidoTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'partido/teamadmin/delete/:id',
    component: PartidoTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'jugador/teamadmin/view/:id',
    component: JugadorTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'jugador/teamadmin/new',
    component: JugadorTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'jugador/teamadmin/edit/:id',
    component: JugadorTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'jugador/teamadmin/delete/:id',
    component: JugadorTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'cuota/teamadmin/view/:id',
    component: CuotaTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  { path: 'cuota/teamadmin/new', component: CuotaTeamadminNewPage, canActivate: [ClubAdminGuard] },
  {
    path: 'cuota/teamadmin/edit/:id',
    component: CuotaTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'cuota/teamadmin/delete/:id',
    component: CuotaTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'pago/teamadmin/view/:id',
    component: PagoTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  { path: 'pago/teamadmin/new', component: PagoTeamadminNewPage, canActivate: [ClubAdminGuard] },
  {
    path: 'pago/teamadmin/edit/:id',
    component: PagoTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'pago/teamadmin/delete/:id',
    component: PagoTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'noticia/teamadmin/view/:id',
    component: NoticiaTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'noticia/teamadmin/new',
    component: NoticiaTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'noticia/teamadmin/edit/:id',
    component: NoticiaTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'noticia/teamadmin/delete/:id',
    component: NoticiaTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'tipoarticulo/teamadmin/view/:id',
    component: TipoarticuloTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'tipoarticulo/teamadmin/new',
    component: TipoarticuloTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'tipoarticulo/teamadmin/edit/:id',
    component: TipoarticuloTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'tipoarticulo/teamadmin/delete/:id',
    component: TipoarticuloTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'articulo/teamadmin/view/:id',
    component: ArticuloTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'articulo/teamadmin/new',
    component: ArticuloTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'articulo/teamadmin/edit/:id',
    component: ArticuloTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'articulo/teamadmin/delete/:id',
    component: ArticuloTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'usuario/teamadmin/view/:id',
    component: UsuarioTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'usuario/teamadmin/new',
    component: UsuarioTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'usuario/teamadmin/edit/:id',
    component: UsuarioTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'usuario/teamadmin/delete/:id',
    component: UsuarioTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  // Teamadmin view-only entity routes
  {
    path: 'club/teamadmin/view/:id',
    component: ClubTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'carrito/teamadmin/view/:id',
    component: CarritoTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentario/teamadmin/view/:id',
    component: ComentarioTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentario/teamadmin/new',
    component: ComentarioTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentario/teamadmin/edit/:id',
    component: ComentarioTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentario/teamadmin/delete/:id',
    component: ComentarioTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentarioart/teamadmin',
    component: ComentarioartTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentarioart/teamadmin/articulo/:id_articulo',
    component: ComentarioartTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentarioart/teamadmin/usuario/:id_usuario',
    component: ComentarioartTeamadminPlistPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'comentarioart/teamadmin/view/:id',
    component: ComentarioartTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'compra/teamadmin/view/:id',
    component: CompraTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'compra/teamadmin/new',
    component: CompraTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'compra/teamadmin/edit/:id',
    component: CompraTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'compra/teamadmin/delete/:id',
    component: CompraTeamadminDeletePage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'puntuacion/teamadmin/view/:id',
    component: PuntuacionTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  // Factura teamadmin (CRUD except delete)
  {
    path: 'factura/teamadmin/view/:id',
    component: FacturaTeamadminViewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'factura/teamadmin/new',
    component: FacturaTeamadminNewPage,
    canActivate: [ClubAdminGuard],
  },
  {
    path: 'factura/teamadmin/edit/:id',
    component: FacturaTeamadminEditPage,
    canActivate: [ClubAdminGuard],
  },
  ...
  {
    path: 'mi/equipos/:id/jugadores',
    component: JugadorUsuarioEquipoPlistPage,
